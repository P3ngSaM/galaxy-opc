    ...
    <div class="agents-layout">
      <section class="card agents-sidebar">
        <div class="row" style="justify-content: space-between;">
          <div>
            <div class="card-title">${t("tabs.agents")}</div>
      ...
      <section class="agents-main">
        ${
          !selectedAgent
            ? html`
                <div class="card">
                  <div class="card-title">${t("agents.selectPrompt.title")}</div>
                  <div class="card-sub">${t("agents.selectPrompt.subtitle")}</div>
                </div>
              `
            : html`
                ${renderAgentHeader(
...
function renderAgentHeader(
  ...
  const subtitle = agent.identity?.theme?.trim() || t("agents.header.defaultSubtitle");
    ...
    <section class="card">
      ...
      <div class="agents-overview-grid" style="margin-top: 16px;">
        ...
        <div class="agent-kv">
          ...
          <div>${skillFilter ? `${skillCount} selected` : t("agents.overview.allSkills")}</div>
        </div>
      </div>
