        ...
        <div class="row" style="justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 12px;">
          <div style="flex: 1; min-width: 250px;">
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 2px;">
              <div class="card-title" style="margin: 0;">${t("usage.title")}</div>
              <span style="
                display: inline-flex;
                align-items: center;
                gap: 6px;
          ...
          <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 8px;">
            <div style="display: flex; gap: 8px; align-items: center;">
              ...
              <span style="color: var(--muted);">${t("usage.dateTo")}</span>
        ...
        <summary>
          ...
          ${
            selectedCount > 0
              ...
              : html`
                  <span class="usage-filter-badge">${t("usage.filterAll")}</span>
                `
          }
        </summary>
    ...
    <section class="card usage-header ${props.headerPinned ? "pinned" : ""}">
            ...
            displayTotals
              ? html`
                <span class="usage-metric-badge">
                  <strong>${formatTokens(displayTotals.totalTokens)}</strong> ${t("usage.metricTokens")}
                </span>
                <span class="usage-metric-badge">
                  <strong>${formatCost(displayTotals.totalCost)}</strong> ${t("usage.metricCost")}
                </span>
                <span class="usage-metric-badge">
      ...
      <div class="usage-header-row">
        <div class="usage-controls">
          ...
          >
            <option value="local">${t("usage.timezoneLocal")}</option>
            <option value="utc">${t("usage.timezoneUTC")}</option>
          </select>
      ...
      <div style="margin-top: 12px;">
          ...
          <input
            ...
            placeholder=${t("usage.queryPlaceholder")}
          ...
          <div class="usage-query-actions">
            ...
            <span class="usage-query-hint">
              ${
                hasQuery
                  ? t("usage.matchCount", { filtered: filteredSessions.length, total: totalSessions })
                  : t("usage.totalCount", { total: totalSessions })
              }
            </span>
          </div>
        </div>
        <div class="usage-filter-row">
          ${renderFilterSelect("agent", t("usage.filterAgent"), agentOptions)}
          ${renderFilterSelect("channel", t("usage.filterChannel"), channelOptions)}
          ${renderFilterSelect("provider", t("usage.filterProvider"), providerOptions)}
          ${renderFilterSelect("model", t("usage.filterModel"), modelOptions)}
          ${renderFilterSelect("tool", t("usage.filterTool"), toolOptions)}
          <span class="usage-query-hint">
            ${t("usage.filterTip")}
          </span>
        </div>
