...
export const pt_BR: TranslationMap = {
  ...
  config: {
    ...
    sectionWizard: "Assistente de Configuração",
    modeForm: "Formulário",
    modeRaw: "Bruto",
    ...
    update: "Atualizar",
    viewChanges: "Ver {count} alteração(ões) pendente(s)",
    navAll: "Todos",
    loadingSchema: "Carregando schema…",
    formWarning: "A visualização de formulário não pode editar alguns campos com segurança. Use Bruto para evitar perder entradas de configuração.",
